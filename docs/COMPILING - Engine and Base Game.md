# Compiling Friday Night Funkin' AND LuaSlice
...
If you experience any issues during the compilation process, DO NOT open an issue on GitHub. Instead, check the [Troubleshooting Guide](BASE GAME STUFF/TROUBLESHOOTING.md) for steps on how to resolve common problems.
