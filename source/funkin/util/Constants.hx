...
class Constants
{
  ...
  public static final LUASLICE_VERSION:String = "v0.0.7";
   ...
   */
  public inline static final SAVE_PATH:String = 'Fla-man-OFFICIAL';

  /**
   * The name of our save slot.
   */
  public inline static final SAVE_NAME:String = 'LuaSlice';

  /**
   * The legacy path where our save data was saved. Used for backwards compatibility.
   */
  public inline static final SAVE_PATH_LEGACY:String = 'Fla-man-OFFICIAL';
