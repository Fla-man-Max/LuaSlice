...
private class HSVColorPickerImpl extends ColorPickerImpl {
    ...
    private function updateSaturationValueGraph() {
        ...
        if (_saturationValueGraphLastHue != null && _saturationValueGraphLastHue == _currentColorHSV.h && _saturationValueGraphBytes != null
            && _saturationValueGraphBytes.length == bytesSize) {
